...
struct ContentView: View {
    ...
    @State private var urlAddOnTextField = ""
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            Group {
                ...
                Divider()
                TextField("urlAddOn", text: $urlAddOnTextField)
                    .border(Color.blue)
                    .fixedSize()
                    .keyboardType(.URL)
                    .textFieldStyle(RoundedBorderTextFieldStyle())
    ...
    ********************************************/
    ...
    func testStretch3() {
        ...
        *************************************/
        let unchartedLink = String("https://www.unchartedlearning.org")
    
        
        let completeURL = unchartedLink + urlAddOnTextField
